...
dimer = ade.Molecule(atoms=[
    ...
    ade.Atom("O", 0.00000000, 0.00000000, 1.74092100),
    ade.Atom("O", 0.00000000, 0.00000000, -1.50417100),
    ade.Atom("H", 0.00000000, 0.75218000, 1.14189700),
    ade.Atom("H", 0.00000000, -0.75218000, 1.14189700),
    ade.Atom("H", 0.00000000, 0.76332300, -2.08889900),
    ade.Atom("H", 0.00000000, -0.76332300, -2.08889900)
])
...
for r in r_values:
    ...
    filename = f"dimer10_translated_{r:.1f}.xyz"
...
xyz_files = glob.glob("dimer10_translated_*.xyz")
print(xyz_files)
...
def run_psi4(xyz_files):
    ...
    np.save('energy_values_dimer10.npy', energy_values)
    np.save('r_values_dimer10.npy', r_values)
