...
idxs = (3, 1, 5)  # NOTE: atoms are 0 indexed
...
for r in r_values:
    ...
    filename = f"dimer5_translated_{r:.1f}.xyz"
...
xyz_files = glob.glob("dimer5_translated_*.xyz")
print(xyz_files)
...
def run_psi4(xyz_files):
    ...
    np.save('energy_values_dimer5.npy', energy_values)
    np.save('r_values_dimer5.npy', r_values)
